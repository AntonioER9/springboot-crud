...
import com.antonio.course.springboot.app.springboot_crud.repositories.RoleRepository;
import com.antonio.course.springboot.app.springboot_crud.repositories.UserRepository;
...
public class UserServiceImpl implements UserService {
  ...
  public User save(User user) {
    ...
    // optionalRoleUser.ifPresent(roles::add); Es lo mismo que la siguiente linea
